            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  child: const Icon(Icons.engineering_rounded, size: 40, color: Colors.white),
                ),
              ),
              ...
              Text(
                'Entre para receber seus chamados',
                textAlign: TextAlign.center,
              ...
              Row(
                ...
                children: [
                  Text('Ainda não é parceiro? ', style: TextStyle(color: Colors.grey.shade600)),
                  TextButton(
